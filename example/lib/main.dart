...
void backgroundFetchHeadlessTask(HeadlessTask task) async {
  ...
  if (taskId == 'flutter_background_fetch') {
    BackgroundFetch.scheduleTask(TaskConfig(
        taskId: "InTrac", delay: 5000, periodic: false, forceAlarmManager: false, stopOnTerminate: false, enableHeadless: true));
  }
  BackgroundFetch.finish(taskId);
}
  ...
  void _onClickEnable(enabled) {
    ...
    if (enabled) {
      BackgroundFetch.start().then((status) {
        ...
        _messangerKey.currentState.showSnackBar(SnackBar(content: Text('Processing Data')));
      }).catchError((e) {
